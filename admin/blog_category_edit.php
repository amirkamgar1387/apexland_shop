...
<div class="container mx-auto px-2 md:px-8">
    <div class="flex flex-col md:flex-row gap-8 mt-8">
        <div class="flex-1">
            <div class="glass-admin p-8 rounded-2xl shadow-xl border border-blue-100 mb-8">
                <h2 class="text-2xl font-extrabold text-blue-700 mb-6 flex items-center gap-2"><i class="fas fa-edit text-blue-500"></i> ویرایش دسته‌بندی وبلاگ</h2>
                <?php if ($success): ?>
                ...
                <?php endif; ?>
                <form action="blog_category_edit_process.php" method="POST" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div class="flex gap-3 items-center mt-2">
                        ...
                        <a href="blog_categories.php" class="flex items-center gap-2 px-8 py-3 rounded-xl border border-blue-300 bg-white text-blue-700 font-bold shadow hover:bg-blue-50 transition">
